...
public class Homepage extends CommonMethod {
  ...
  Assert.assertTrue(element.isDisplayed());
	...
	public void you_will_go_to_the_next_page_verify_with_the_header_is_correct_then_go_back_to_homepage_use_example_list_below(String string) throws InterruptedException {
		
	

		String ActualTitle = BaseClass.getDriver().getTitle();

		String CompositePageTitle = "Composite Fillings in Thornhill, Ontario | Disera Dental";

		Assert.assertEquals(ActualTitle, CompositePageTitle);
		...
		String DentalBondingPagetitle = "Dental Bonding in Thornhill, Ontario | Disera Dental";

		Assert.assertEquals(ActualTitle1, DentalBondingPagetitle);
		...
		String DentalBridgeTitle = "Dental Bridges in Thornhill, Ontario | Disera Dental";

		Assert.assertEquals(ActualTitle2, DentalBridgeTitle);
		...
		Assert.assertEquals(ActualTitle3, dentalCrownsTitle);
